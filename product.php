  ...
  <div class="p-4 sm:ml-64">
     <div class=" border-2 border-gray-200 border-dashed rounded-lg dark:border-gray-700 mt-14">
        ...
        <!-- <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="p-8 rounded-t-lg" src="https://imgcdn.solopos.com/@space/_large/2016/07/icO52Qs4-Trofi-Euro.jpg" alt="product image" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
     ...
     <div class="flex flex-wrap justify-center gap-4">
        ...
        if ($result->num_rows > 0) {
            ...
            while($row = $result->fetch_assoc()) {
                echo '
        <div class="max-w-sm bg-white rounded overflow-hidden shadow-lg card-container">
            <img class="w-full" src="assets/img/'.$row["gambar"].'" alt="Product Image">
            <div class="px-5 pb-5 card-content">
                <br>
                <a href="#">
                    <h5 class="text-xl font-semibold tracking-tight text-gray-900 card-title">'.$row["nama_produk"].'</h5>
                </a>
                <br>
                ...
                <div class="px-1 py-2">
                    <span class="inline-block bg-gray-200 rounded-full px-3 py-1 text-sm font-semibold text-gray-700">#tag1</span>
            ...
            <div class="flex items-center justify-between px-5 pb-5">
                <span class="text-3xl font-bold text-gray-900">Rp.'.number_format($row["harga_produk"], 0).'</span>
                <button data-product-id="'.$row["id_produk"].'" class="add-to-cart-btn text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Add to cart</button>
            </div>
        </div>';
            }
        } else {
